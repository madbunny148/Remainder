...
import sqlite3
from remindview import Ui_Dialog
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(713, 390)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.lbl1 = QtWidgets.QLabel(self.centralwidget)
        self.lbl1.setGeometry(QtCore.QRect(160, 20, 311, 51))
        font = QtGui.QFont()
        ...
        self.lbl2.setGeometry(QtCore.QRect(140, 85, 171, 41))
        self.lbl2.setObjectName("lbl2")
        self.lbl3 = QtWidgets.QLabel(self.centralwidget)
        self.lbl3.setGeometry(QtCore.QRect(140, 150, 61, 31))
        font = QtGui.QFont()
        ...
        self.lbl4.setGeometry(QtCore.QRect(140, 210, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.textbox1.setGeometry(QtCore.QRect(360, 59, 104, 61))
        self.textbox1.setObjectName("textbox1")
        self.button1 = QtWidgets.QPushButton(self.centralwidget)
        self.button1.setGeometry(QtCore.QRect(140, 270, 56, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.button2.setGeometry(QtCore.QRect(310, 280, 111, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.button3.setGeometry(QtCore.QRect(140, 330, 51, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.button3.setFont(font)
        self.button3.setObjectName("button3")
        self.button3.clicked.connect(self.showChildWindow)
        self.button4 = QtWidgets.QPushButton(self.centralwidget)
        self.button4.setGeometry(QtCore.QRect(210, 330, 91, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.button5.setGeometry(QtCore.QRect(350, 330, 91, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.dateEdit.setGeometry(QtCore.QRect(360, 131, 101, 51))
        self.dateEdit.setObjectName("dateEdit")
        self.timeEdit = QtWidgets.QTimeEdit(self.centralwidget)
        self.timeEdit.setGeometry(QtCore.QRect(360, 200, 101, 41))
